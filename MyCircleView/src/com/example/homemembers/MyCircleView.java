...
public class MyCircleView extends AbCircleView {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (index) {
                ...
                case R.styleable.myCircleView_radiusRound:
                    rediusCircleRound = (int) a.getDimension(index, 50);
                    break;
    ...
    private void createAddCircleView(Context context) {
        ...
        firstAddView.setBackgroundColor(Color.TRANSPARENT);
        firstAddView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        LayoutParams lp = new LayoutParams(2 * rediusCircleRound, 2 * rediusCircleRound);
        firstAddView.setLayoutParams(lp);
        firstAddView.setImageResource(android.R.drawable.ic_menu_add);
    ...
    public int getRediusCircleRound() {
        return rediusCircleRound;
    }
    ...
    private void addAdapterView() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            ImageButton imageView = (ImageButton) mAdapter.getView(i, this, this);
